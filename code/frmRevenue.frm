...
Begin VB.Form frmRevenueRpt 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboProducts 
         ...
         Width           =   6135
      End
      Begin Crystal.CrystalReport CrystalRevenue 
         Left            =   7440
         Top             =   1080
         _ExtentX        =   741
         _ExtentY        =   741
   ...
   End
End
Attribute VB_Name = "frmRevenueRpt"
...
CrystalRevenue.ReportFileName = App.Path & "\ItemsBought.rpt"
CrystalRevenue.Connect = "DSN=nxomen;UID=sa;PWD=Abu;DSQ=ZuksData"
...
CrystalRevenue.SelectionFormula = "{Products.ProductName}='" & Trim(Me.cboProducts) & "'"
End If
...
If Me.cboProducts = "All" And Me.ChkDate = vbUnchecked Then
CrystalRevenue.SelectionFormula = ""
End If


If Me.dtpfrom <= Me.dtpto And Me.cboProducts = "All" And Me.ChkDate = vbChecked Then
CrystalRevenue.SelectionFormula = "{Payments/Products.Date} >=#" & Me.dtpfrom & "# and {Payments/Products.Date} <=#" & Me.dtpto & "#"
End If

'And Me.cboReport = "Specified Time Period" Then

If Me.dtpfrom <= Me.dtpto And Me.cboProducts <> "All" And Me.ChkDate = vbChecked Then
CrystalRevenue.SelectionFormula = "{Payments/Products.Date} >=#" & Me.dtpfrom & "# and {Payments/Products.Date} <=#" & Me.dtpto & "# and {Products.ProductName}='" & Trim(Me.cboProducts) & "'"
End If



   CrystalRevenue.WindowState = crptMaximized
   CrystalRevenue.WindowShowRefreshBtn = True
   Me.CrystalRevenue.WindowTitle = "SALES REVENUE " & Format$(Date, "yyyy")
   
   CrystalRevenue.Action = 1
